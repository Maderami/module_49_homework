...
class __TwigTemplate_0b822cd5600e4dbb3efda2a27f2bfcb8 extends Template
{
    ...
    public function block_content(array $context, array $blocks = []): iterable
    {
        $macros = $this->macros;
        // line 4
        yield "    <section class=\"py-3 py-md-5 py-xl-8\">
        <div class=\"container\">
            <div class=\"row justify-content-md-center\">
                <div class=\"col-12 col-md-10 col-lg-8 col-xl-7 col-xxl-6\">
                    <h2 class=\"mb-4 display-5 text-center\">Нужна помощь</h2>
                    <p class=\"text-secondary mb-5 text-center lead fs-4\">Напишите нам через форму обратной связи, ответ направим на почту.</p>
                    ...
                    <div class=\"card border border-dark rounded shadow-sm overflow-hidden\">
                        <div class=\"card-body p-0\">
                            <div class=\"row gy-3 gy-md-4 gy-lg-0\">
                                <div class=\"col-12 col-lg-6 bsb-overlay background-position-center background-size-cover\" style=\"--bsb-overlay-opacity: 0.7; background-image: url('";
        // line 21
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(($context["__DIR__"] ?? null), "html", null, true);
        yield "core/views/templates/resources/images/forcontacts.jpg');\">
                                    <div class=\"row align-items-lg-center justify-content-center h-100\">
                                        <div class=\"col-11 col-xl-10\">
                                            <div class=\"contact-info-wrapper py-4 py-xl-5\">
                                                <h2 class=\"h1 mb-3 text-light\">Форма для связи</h2>
                                                <p class=\"lead fs-4 text-light opacity-75 mb-4 mb-xxl-5\">Мы всегда готовы сотрудничать с новыми клиентами. Если вы заинтересованы в сотрудничестве с нами, пожалуйста, свяжитесь с нами одним из следующих способов.</p>
                                                <div class=\"d-flex mb-4 mb-xxl-5\">
                                                    ...
                                                    <div>
                                                        <h4 class=\"mb-3 text-light\">Адрес</h4>
                                                        <address class=\"mb-0 text-light opacity-75\">Омск</address>
                                                    </div>
                                                </div>
                                                <div class=\"row mb-4 mb-xxl-5\">
                                                    <div class=\"col-12 col-xxl-6\">
                                                        <div class=\"d-flex mb-4 mb-xxl-0\">
                                                            ...
                                                            <div>
                                                                <h4 class=\"mb-3 text-light\">Телефон</h4>
                                                                <p class=\"mb-0\">
                                                ...
                                                <div class=\"d-flex\">
                                                    ...
                                                    <div>
                                                        <h4 class=\"mb-3 text-light\">Рабочий график</h4>
                                                        <div class=\"d-flex mb-1\">
                                                            <p class=\"text-light fw-bold mb-0 me-5\">Пн - Пт</p>
                                                            <p class=\"text-light opacity-75 mb-0\">9 - 17</p>
                                                        </div>
                                                        <div class=\"d-flex\">
                                                            <p class=\"text-light fw-bold mb-0 me-5\">Суб - Вс</p>
                                                            <p class=\"text-light opacity-75 mb-0\">Выходной</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <span class=\"input-group-text\">
                              <svg xmlns=\"http://www.w3.org/2000/svg\" width=\"16\" height=\"16\" fill=\"currentColor\" class=\"bi bi-telephone\" viewBox=\"0 0 16 16\">
                                <path d=\"M3.654 1.328a.678.678 0 0 0-1.015-.063L1.605 2.3c-.483.484-.661 1.169-.45 1.77a17.568 17.568 0 0 0 4.168 6.608 17.569 17.569 0 0 0 6.608 4.168c.601.211 1.286.033 1.77-.45l1.034-1.034a.678.678 0 0 0-.063-1.015l-2.307-1.794a.678.678 0 0 0-.58-.122l-2.19.547a1.745 1.745 0 0 1-1.657-.459L5.482 8.062a1.745 1.745 0 0 1-.46-1.657l.548-2.19a.678.678 0 0 0-.122-.58L3.654 1.328zM1.884.511a1.745 1.745 0 0 1 2.612.163L6.29 2.98c.329.423.445.974.315 1.494l-.547 2.19a.678.678 0 0 0 .178.643l2.457 2.457a.678.678 0 0 0 .644.178l2.189-.547a1.745 1.745 0 0 1 1.494.315l2.306 1.794c.829.645.905 1.87.163 2.611l-1.034 1.034c-.74.74-1.846 1.065-2.877.702a18.634 18.634 0 0 1-7.01-4.42 18.634 18.634 0 0 1-4.42-7.009c-.362-1.03-.037-2.137.703-2.877L1.885.511z\" />
                                                    ...
                                                    <div class=\"col-12\">
                                                        <label for=\"message\" class=\"form-label\">Текст обращения <span class=\"text-danger\">*</span></label>
                                                        <textarea class=\"form-control\" id=\"message\" name=\"message\" rows=\"3\" required></textarea>
                                                    </div>
                                                    <div class=\"col-12\">
                                                        <div class=\"d-grid\">
                                                            <button class=\"btn btn-primary btn-lg\" type=\"submit\">Отправка письма</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </form>
...
";
    ...
    {
        return array (  77 => 21,  58 => 4,  51 => 3,  40 => 1,);
    }
            ...
            <div class=\"row\">
                <div class=\"col-12\">
                    <div class=\"card border border-dark rounded shadow-sm overflow-hidden\">
                        <div class=\"card-body p-0\">
                            <div class=\"row gy-3 gy-md-4 gy-lg-0\">
                                <div class=\"col-12 col-lg-6 bsb-overlay background-position-center background-size-cover\" style=\"--bsb-overlay-opacity: 0.7; background-image: url('{{ __DIR__ }}core/views/templates/resources/images/forcontacts.jpg');\">
                                    <div class=\"row align-items-lg-center justify-content-center h-100\">
                                        <div class=\"col-11 col-xl-10\">
                                            <div class=\"contact-info-wrapper py-4 py-xl-5\">
                                                <h2 class=\"h1 mb-3 text-light\">Форма для связи</h2>
